...
export default async function ProductPage({ params }: Props) {
  ...
  if (!product) {
    notFound(); // Esto muestra la página 404 de Next.js automáticamente
  }
  ...
  // 3. Generador de Link de WhatsApp (Smart Link)
  const whatsappNumber = '960633393'; // ¡PON TU NÚMERO REAL AQUÍ LUEGO!
        ...
        <div className="relative aspect-square overflow-hidden rounded-xl border bg-slate-100 shadow-sm">
          {product.images[0] ? (
            <Image
              ...
              priority // Carga esta imagen rápido, es la principal
